...
export default function HeroSection() {
  ...
  const stats = [
    { icon: Zap, ...t.hero.stat1 },
    { icon: Shield, ...t.hero.stat2 },
    { icon: Users, ...t.hero.stat3 },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-white/90 text-sm font-medium px-4 py-1.5 rounded-full mb-6"
            >
            ...
            >
              <Link href="/dich-vu" className="btn-accent text-base px-7 py-3.5">
                {t.hero.cta1}
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-8 -right-4 bg-white rounded-2xl shadow-xl p-4"
            >
